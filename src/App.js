...
function App() {
  ...
  //Use State and map the apps out to the AppCard component
  const [apps, setApps] = useState([
    {
      name: "App Installer",
      description: "",
      image: "https://paradise.getzeus.app/icons/App_Installer/icon.png?12",
      url: "https://paradise.getzeus.app/ipas/App_Installer.ipa"
    },
    {
      name: "Fortnite",
      description: "",
      image: "https://paradise.getzeus.app/icons/Fortnite/icon.png?12",
      url: "https://paradise.getzeus.app/ipas/Fortnite.ipa"
    },
    {
      name: "Instagram++",
      description: "",
      image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Instagram-Icon.png/800px-Instagram-Icon.png",
      url: "https://paradise.getzeus.app/ipas/Instagram%2B%2B.ipa"
    },
    {
      name: "Youtube++",
      description: "",
      image: "https://icons-for-free.com/download-icon-app+global+ios+media+social+youtube+icon-1320193331371761915_512.png",
      url: "https://paradise.getzeus.app/ipas/Youtube%2B%2B.ipa"
    },
    {
      name: "Flappy Bird",
      description: "",
      image: "https://paradise.getzeus.app/icons/FlappyBird/icon.png?12",
      url: "https://paradise.getzeus.app/ipas/FlappyBird.ipa",
    }
  ...
  return (
    ...
    <div className="App">
      ...
      <script src="https://cdnjs.cloudflare.com/ajax/libs/react/15.1.0/react-dom.min.js"></script>
            ...
            {/*<MobileView>*/}
            <div className='container sticky top-0 bg-white header flex p-4'>
      <h1 className='text-3xl font-bold'>IPALib</h1>
      <div className='flex-1'></div>
      <input onChange={handleSearchChange} className="w-[10rem] outline-double outline-gray-500 rounded-lg p-5 outline-1 h-6 place-items-center" placeholder='Search...' type="text" />
      <div className='flex-1'></div>
      More Apps
      </div>
      ...
      <div className='container justify-start place-items-start flex flex-col p-4'>
        <h2>Quick Tip: </h2>
        <p className='mx-8'>Keep Scrolling for more apps!</p>
      </div>

      <div className='header'>
        <img src="https://i.imgur.com/WKPUuEP.jpeg"></img>
      </div>

      <div className='Apps bg-white sticky top-0 flex p-4 text-2xl font-bold'>
        <h1>Apps We Offer</h1>
...
<div class="w-full h-screen">
	<section id="bottom-navigation" class="block fixed inset-x-0 bottom-0 z-10 backdrop-blur bg-opacity-75 bg-white shadow">
